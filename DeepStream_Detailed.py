...
# Now we can change the configuration and recompile our application. Open the [configuration](../../../../edit/tasks/l-iv-04/task/DeepStream_Release/sources/apps/deepstream-test1/dstest1_pgie_config.txt) and update the element of `threshold` to be `0.8`. This will cange the threshold for all of the classes. Save the file, then remake the application with the code below. 
...
get_ipython().system('make -C DeepStream_Release/sources/libs/nvdsparsebbox2 clean')

# build the library
get_ipython().system('make -C DeepStream_Release/sources/libs/nvdsparsebbox2')
...
get_ipython().system('dot -Tpng ./REPLACE_ME > ./ex4_pipeline.png')
...
# In addition, the dewarper plugin requires a `config-file` which specifies the camera specs and the output videos properties. You can open the [configuration file](../../../../edit/tasks/l-iv-04/task/DeepStream_Release/sources/apps/deepstream-test5/config_dewarper.txt)  and inspect the paramters; 
# 
...
# 
# 
# Open [deepstream_test1_app.c](../../../../edit/tasks/l-iv-04/task/DeepStream_Release/sources/apps/deepstream-test1/deepstream_test1_app.c)  and uncomment the following lines of code (lines 355 and 356 unless you have added new lines to the file).
# 
# ```c
...
# Open [smi.log](../../../../edit/tasks/l-iv-04/task/DeepStream_Release/samples/smi.log) and observe decoder and SM utilization. It should look pretty similar to the output from the previous section, with several utilization metrics slightly higher.
# 
# 
